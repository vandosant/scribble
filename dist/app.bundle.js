...
/* harmony default export */ __webpack_exports__["a"] = (keyboardModel);
...
/* harmony default export */ __webpack_exports__["a"] = (oscillator);
...
/* harmony default export */ __webpack_exports__["a"] = (DrumController);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Context__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Oscillator__ = __webpack_require__(3);
...
function oscillatorController(options) {
  ...
  var createOscillators = function () {
    for (var i = 0; i < 13; i++) {
      var osc = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Oscillator__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_0__Context__["a" /* default */], initialFrequency, initialVolume);
...
/* harmony default export */ __webpack_exports__["a"] = (oscillatorController);
...
var drawVisual;
var analyser = __WEBPACK_IMPORTED_MODULE_0__Context__["a" /* default */].createAnalyser();
...
function visualize() {
  ...
  function init(containerId, nodes) {
    ...
    dest = __WEBPACK_IMPORTED_MODULE_0__Context__["a" /* default */].createMediaStreamDestination();
    var source = __WEBPACK_IMPORTED_MODULE_0__Context__["a" /* default */].createMediaStreamSource(dest.stream);
...
/* harmony default export */ __webpack_exports__["a"] = (visualize);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Keyboard__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Context__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Keyboard__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__keyboardController__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__OscillatorController__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__DrumController__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__DrumMachine__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Oscillator__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Visualizer__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Recorder__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__styles_application_scss__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__styles_application_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__styles_application_scss__);
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__Recorder__["a" /* default */])({record: '#record', stop: '#stop', play: '#play'})
.then(function(stream) {
...
var drumVol = 1.3;
var viz = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__Visualizer__["a" /* default */])();
var drums = [
  {
    identifier: 'bass',
    'bass': {
      'machine': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__DrumMachine__["a" /* default */])({context: __WEBPACK_IMPORTED_MODULE_0__Context__["a" /* default */], frequency: 47, wave: 'sine', gainVal: drumVol, sustain: 0.03, viz: viz})
    }
  },
  {
    identifier: 'tom1',
    'tom1': {
      'machine': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__DrumMachine__["a" /* default */])({context: __WEBPACK_IMPORTED_MODULE_0__Context__["a" /* default */], frequency: 64, wave: 'sine', gainVal: drumVol, sustain: 0.05, viz: viz})
    }
  },
  {
    identifier: 'tom2',
    'tom2': {
      'machine': __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__DrumMachine__["a" /* default */])({
        context: __WEBPACK_IMPORTED_MODULE_0__Context__["a" /* default */],
        frequency: 160,
        wave: 'sine',
        gainVal: drumVol,
        sustain: 0.05,
...
var drumController = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__DrumController__["a" /* default */])(drums, 'drums', 180, drumVol);
...
var oscillatorCtrl = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__OscillatorController__["a" /* default */])({
  oscillators: [],
  initialVolume: 0,
...
document.addEventListener('DOMContentLoaded', function () {
  var keyboard = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__Keyboard__["a" /* default */])({volumeSelector: 'keyboard-volume', oscillators: oscillatorCtrl.oscillators});
  keyboard.initialize();

  var keyboardCtrl = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__keyboardController__["a" /* default */])(keyboard);
...
// module
exports.push([module.i, "body {\n  width: 100%;\n  font-family: 'Geo', sans-serif;\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  box-sizing: border-box; }\n\n.title {\n  font-family: 'Cedarville Cursive', cursive;\n  font-size: 1.8em;\n  color: #453A38; }\n\n.container, .padded-container {\n  width: 30%;\n  margin: .6em auto;\n  background-color: #eeeeee;\n  border: 0.4em solid #b94d07;\n  text-align: center; }\n\n.padded-container {\n  padding: .6em; }\n\n.oscillator-container {\n  width: 70%;\n  margin: .6em auto;\n  text-align: center;\n  border: none;\n  padding: 0;\n  background: none; }\n  .oscillator-container select {\n    background: white;\n    border-radius: 0px;\n    outline: none; }\n\nbutton {\n  font-size: 1em;\n  font-family: 'Geo', sans-serif;\n  background: #fff;\n  border: 2px solid #498283;\n  outline: none; }\n\ninput[type='range'] {\n  -webkit-appearance: none;\n  background-color: rgba(192, 192, 192, 0.7);\n  width: 200px;\n  height: 20px;\n  border-radius: 2em;\n  outline: none; }\n\ninput[type=\"range\"]::-webkit-slider-thumb {\n  -webkit-appearance: none;\n  background-color: #D73033;\n  border: 2px solid #453A38;\n  width: 2em;\n  height: 2em;\n  border-radius: 2em; }\n\n.keyboard {\n  margin: 0 auto;\n  width: 18em; }\n\n.keyboard-container:before,\n.keyboard-container:after {\n  overflow: hidden;\n  display: block;\n  zoom: 1;\n  content: ' '; }\n\n.keyboard-container:after {\n  clear: both; }\n\n.key {\n  float: left;\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  box-sizing: border-box;\n  height: 10em;\n  width: 2em;\n  border: .3em solid black;\n  background: #fff; }\n\n.key + .key {\n  margin-left: .25em; }\n\n.black-key {\n  float: left;\n  position: relative;\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  box-sizing: border-box;\n  height: 7em;\n  width: 1.4em;\n  border: .3em solid black;\n  background: #000;\n  margin-left: -.6em;\n  margin-right: -.6em; }\n\n.keyon {\n  background: #B2A187; }\n\n.octave {\n  margin: 0 auto;\n  width: 32.1%;\n  cursor: pointer;\n  text-transform: capitalize; }\n  .octave #octave-down {\n    float: left;\n    -webkit-box-sizing: border-box;\n    -moz-box-sizing: border-box;\n    box-sizing: border-box;\n    height: 10em;\n    width: 2em;\n    border: .3em solid black;\n    background: #fff; }\n  .octave #octave-up {\n    float: right;\n    -webkit-box-sizing: border-box;\n    -moz-box-sizing: border-box;\n    box-sizing: border-box;\n    height: 10em;\n    width: 2em;\n    border: .3em solid black;\n    background: #fff; }\n  .octave .octave-text {\n    font-size: .9em;\n    margin-top: 200%; }\n\n.drum-machine {\n  margin: .5em auto;\n  width: 80%;\n  text-align: center; }\n\n.drum-container > .drum-button, .drum-container > .drum-type {\n  margin-bottom: .2em; }\n\n.drum-button + .drum-button, .drum-type + .drum-button, .drum-button + .drum-type, .drum-type + .drum-type {\n  margin-left: .2em; }\n\n.drum-button, .drum-type {\n  width: 3em;\n  height: 1em;\n  border: .3em solid black;\n  cursor: pointer;\n  display: inline-block;\n  line-height: .9em; }\n  .drum-button:hover, .drum-type:hover {\n    display: inline-block;\n    background: #498283; }\n\n.drum-button-active {\n  border: 0.3em solid #b94d07; }\n\n.drum-button-selected {\n  background: #498283; }\n\n.drum-type {\n  line-height: 1em; }\n  .drum-type:hover, .drum-type.drum-button-selected {\n    background: #D73033; }\n\n#play, #pause, #fwd, #rew {\n  width: 80px;\n  height: 80px;\n  background: white;\n  position: relative;\n  display: block;\n  cursor: hand; }\n\n#play:before {\n  width: 0;\n  height: 0;\n  border-left: 15px solid #453A38;\n  border-right: 15px solid transparent;\n  border-top: 15px solid transparent;\n  border-bottom: 15px solid transparent;\n  position: absolute;\n  content: \"\";\n  top: 2px;\n  left: 40px; }\n\n#pause:before {\n  width: 8px;\n  height: 25px;\n  background: #453A38;\n  position: absolute;\n  content: \"\";\n  top: 5px;\n  left: 35px; }\n\n#pause:after {\n  width: 8px;\n  height: 25px;\n  background: #453A38;\n  position: absolute;\n  content: \"\";\n  top: 5px;\n  right: 25px; }\n\n#drum-properties {\n  overflow: hidden;\n  width: 25%;\n  margin: 0 auto; }\n  #drum-properties ul li {\n    float: left;\n    list-style-type: none;\n    padding-left: 1em; }\n  #drum-properties ul input[type='range'] {\n    width: 100px;\n    height: 9px; }\n  #drum-properties ul input[type=\"range\"]::-webkit-slider-thumb {\n    width: 1em;\n    height: 1em; }\n\n.oscillator, .oscillator-modes {\n  display: inline-block;\n  height: 3em;\n  width: 6em;\n  padding-top: .3em;\n  background: #498283;\n  border: 0.4em solid #453A38; }\n\n.oscillator-modes {\n  background: #B2A187; }\n\n#tempo {\n  width: 4em; }\n\n#top {\n  width: 100%; }\n", ""]);
